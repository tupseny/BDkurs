...
INSERT INTO player (title ,hp, hungry, exp, unv_id, inv_id) VALUES (DEFAULT, 20, 20, 9999999, 0, 0);
INSERT INTO player (title ,hp, hungry, exp, unv_id, inv_id) VALUES ('danik', 20, 20, 25, 0, 1);
INSERT INTO player (title ,hp, hungry, exp, unv_id, inv_id) VALUES ('martin', 20, 20, 280, 0, 2);

INSERT INTO word (title, size, seed, gm_id) VALUES (DEFAULT , 182137121, random()*10000, 0);
INSERT INTO word (title, size, seed, gm_id) VALUES ('heaven' , 125662, random()*10000, 0);
INSERT INTO word (title, size, seed, gm_id) VALUES ('nether' , 563248, random()*10000, 0);
INSERT INTO word (title, size, seed, gm_id) VALUES ('dungeon' , 25630, random()*10000, 0);
...
INSERT INTO biome (title, prec_id, bl_id ) VALUES ('ocean', 0, 8);
INSERT INTO biome (title, prec_id, bl_id ) VALUES ('plains', 0, 2);
INSERT INTO biome (title, prec_id, bl_id ) VALUES ('desert', 0, 10);
INSERT INTO biome (title, prec_id, bl_id ) VALUES ('extreme_hills', 0, 1);
INSERT INTO biome (title, prec_id, bl_id ) VALUES ('forest', 0, 2);
INSERT INTO biome (title, prec_id, bl_id ) VALUES ('taiga', 1, 3);
INSERT INTO biome (title, prec_id, bl_id ) VALUES ('frozen_ocean', 0, 28);
INSERT INTO biome (title, prec_id, bl_id ) VALUES ('ice_plains', 2, 29);
INSERT INTO biome (title, prec_id, bl_id ) VALUES ('jungle', 1, 2);
INSERT INTO biome (title, prec_id, bl_id ) VALUES ('rain_forest', 3, 2);
INSERT INTO biome (title, prec_id, bl_id ) VALUES ('hell', 0, 30);
...
INSERT INTO mob (title, fm_id, hp, dmg, dmg_id) VALUES ('bat', 0, 4, 0, DEFAULT );
INSERT INTO mob (title, fm_id, hp, dmg, dmg_id) VALUES ('chicken', 0, 6, 0, DEFAULT );
INSERT INTO mob (title, fm_id, hp, dmg, dmg_id) VALUES ('spider', 1, 10, 2, 0 );
...
INSERT INTO mob (title, fm_id, hp, dmg, dmg_id) VALUES ('horse', 3, 16, 0, DEFAULT );
INSERT INTO mob (title, fm_id, hp, dmg, dmg_id) VALUES ('iron_golem', 4, 20, 8, 0 );
